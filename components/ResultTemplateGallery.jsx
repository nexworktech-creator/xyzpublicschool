...
// Small logo badge shown in the preview cards so Admin can confirm the
// uploaded logo before it appears on the real, printed report card.
function LogoBadge({ logoUrl, size = 22, className = "" }) {
...
function TemplatePreview({ t, schoolName, logoUrl }) {
    ...
    return (
      <div className="overflow-hidden rounded-sm border border-navy-100 bg-white p-2 text-[8px] leading-tight text-black">
        <div className="flex items-center justify-between text-[6.5px]">
          ...
          <LogoBadge logoUrl={logoUrl} size={18} />
  ...
  return (
    <div className="overflow-hidden rounded-sm border border-navy-100 bg-white text-[9px] leading-tight">
      {/* Header */}
      {t.headerStyle === "band" ? (
        <div className="flex items-center justify-center gap-1.5 px-2 py-2 text-center text-white" style={{ backgroundColor: t.accent }}>
          <LogoBadge logoUrl={logoUrl} className="bg-white/90 p-0.5" />
          <div>
        ...
        <div className="m-1.5 rounded-sm border-2 p-2 text-center" style={{ borderColor: t.accent }}>
          <div className="flex items-center justify-center gap-1.5 rounded-sm border p-1" style={{ borderColor: t.accentSoft }}>
        ...
        <div className="flex items-center justify-center gap-1.5 border-b px-2 py-2 text-center" style={{ borderColor: t.accent }}>
          <LogoBadge logoUrl={logoUrl} />
          <div>
            <p className="text-[11px] font-bold" style={{ color: t.accent }}>{schoolName}</p>
        ...
        <div className="m-1.5 flex items-center justify-center gap-1.5 rounded-sm border p-2 text-center" style={{ borderColor: t.accent }}>
          <LogoBadge logoUrl={logoUrl} />
          <div>
            <p className="text-[11px] font-bold" style={{ color: t.accent }}>{schoolName}</p>
            <p className="text-[7px] text-navy-400">OFFICIAL REPORT CARD</p>
        ...
        <div className="mt-5 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {RESULT_TEMPLATES.map((t) => {
            ...
            return (
              ...
              >
                <TemplatePreview t={t} schoolName={previewSchoolName} logoUrl={settings?.logoUrl} />
